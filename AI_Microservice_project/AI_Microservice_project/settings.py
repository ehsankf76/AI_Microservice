...
SECRET_KEY = 'django-insecure-+t!mq+#m-8_oe*75ce-+qaw7#*u#0484p4(vu%lz=a=8+*vg2f'
...
ROOT_URLCONF = 'AI_Microservice_project.urls'
...
WSGI_APPLICATION = 'AI_Microservice_project.wsgi.application'
